...
#define ROUTE_0_N_WAYPOINTS (2)
static const struct Waypoint route0[ROUTE_0_N_WAYPOINTS] = {
  { { +0.0, +0.0, -1.0 }, +1.0, +0.35, +0.0, +0.2, +0.2, 10000 },
  { { +0.0, +0.0, +1.5 }, +0.7, +0.35, +0.0, +0.2, +0.2, 0 },
};

#define ROUTE_1_N_WAYPOINTS (10)
static const struct Waypoint route1[ROUTE_1_N_WAYPOINTS] = {
  { { +0.0, +0.0, -1.5 }, +1.0, +0.35, +0.0, +0.2, +0.2, 0 },
  { { +2.0, +0.0, -1.5 }, +1.0, +0.35, +0.0, +0.2, +0.2, 0 },
  { { +2.0, +3.5, -1.5 }, +1.0, +0.35, +0.0, +0.2, +0.2, 0 },
  { { +6.6, +3.5, -1.5 }, +1.0, +0.35, +0.0, +0.2, +0.2, 0 },
  { { +6.6, -0.5, -1.5 }, +1.0, +0.35, +0.0, +0.2, +0.2, 0 },
  { { +6.6, +3.5, -1.5 }, +1.0, +0.35, +0.0, +0.2, +0.2, 0 },
  { { +2.0, +3.5, -1.5 }, +1.0, +0.35, +0.0, +0.2, +0.2, 0 },
  { { +2.0, +0.0, -1.5 }, +1.0, +0.35, +0.0, +0.2, +0.2, 0 },
  { { +0.0, +0.0, -1.5 }, +1.0, +0.35, +0.0, +0.2, +0.2, 0 },
...
static const struct Waypoint route2[ROUTE_2_N_WAYPOINTS] = {
  ...
  { { +6.6, +3.5, -1.5 }, +1.0, +0.35, +0.0, +0.2, +0.2, 0 },
  { { +6.6, -0.5, -1.5 }, +1.0, +0.35, +0.0, +0.2, +0.2, 0 },
  { { +9.9, -0.5, -1.5 }, +1.0, +0.35, +0.0, +0.2, +0.2, 0 },
  { { +11.2, -0.5, -1.5 }, +0.5, +0.35, +0.0, +0.2, +0.2, 3000 },
  { { +11.2, +3.5, -1.5 }, +0.5, +0.35, +0.0, +0.2, +0.2, 5000 },
  { { +11.2, -0.5, -1.5 }, +0.5, +0.35, +0.0, +0.2, +0.2, 0 },
  { { +6.6, -0.5, -2.5 }, +1.0, +0.35, +0.0, +0.2, +0.2, 0 },
  { { +2.0, +0.0, -2.5 }, +1.0, +0.35, +0.0, +0.2, +0.2, 0 },
  { { +0.0, +0.0, -1.5 }, +0.5, +0.35, +0.0, +0.2, +0.2, 0 },
  { { +0.0, +0.0, +1.5 }, +0.7, +0.35, +0.0, +0.2, +0.2, 0 },
};
