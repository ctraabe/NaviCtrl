...
#define ROUTE_0_N_WAYPOINTS (10)
static const struct Waypoint route0[ROUTE_0_N_WAYPOINTS] = {
  { { +0.0, +0.0, -1.5 }, +1.0, +0.25, +0.0, +0.2, +0.2, 0 },
  { { +2.0, +0.0, -1.5 }, +1.0, +0.25, +0.0, +0.2, +0.2, 0 },
  { { +2.0, +3.5, -1.5 }, +1.0, +0.25, +0.0, +0.2, +0.2, 0 },
  { { +6.6, +3.5, -1.5 }, +1.0, +0.25, +0.0, +0.2, +0.2, 0 },
  { { +6.6, -0.5, -1.5 }, +1.0, +0.25, +0.0, +0.2, +0.2, 5000 },
  { { +6.6, +3.5, -1.5 }, +1.0, +0.25, +0.0, +0.2, +0.2, 0 },
  { { +2.0, +3.5, -1.5 }, +1.0, +0.25, +0.0, +0.2, +0.2, 0 },
  { { +2.0, +0.0, -1.5 }, +1.0, +0.25, +0.0, +0.2, +0.2, 0 },
  { { +0.0, +0.0, -1.5 }, +1.0, +0.25, +0.0, +0.2, +0.2, 0 },
  { { +0.0, +0.0, +1.5 }, +0.7, +0.25, +0.0, +0.2, +0.2, 0 },
};

#define ROUTE_1_N_WAYPOINTS (12)
static const struct Waypoint route1[ROUTE_1_N_WAYPOINTS] = {
  { { +0.0, +0.0, -1.5 }, +1.0, +0.25, +0.0, +0.2, +0.2, 0 },
  { { +2.0, +0.0, -1.5 }, +1.0, +0.25, +0.0, +0.2, +0.2, 0 },
  { { +2.0, +3.5, -1.5 }, +1.0, +0.25, +0.0, +0.2, +0.2, 0 },
  { { +6.6, +3.5, -1.5 }, +1.0, +0.25, +0.0, +0.2, +0.2, 0 },
  { { +6.6, -0.5, -1.5 }, +1.0, +0.25, +0.0, +0.2, +0.2, 0 },
  { { +11.2, -0.5, -1.5 }, +1.0, +0.25, +0.0, +0.2, +0.2, 5000 },
  { { +6.6, -0.5, -1.5 }, +1.0, +0.25, +0.0, +0.2, +0.2, 0 },
  { { +6.6, +3.5, -1.5 }, +1.0, +0.25, +0.0, +0.2, +0.2, 0 },
  { { +2.0, +3.5, -1.5 }, +1.0, +0.25, +0.0, +0.2, +0.2, 0 },
  { { +2.0, +0.0, -1.5 }, +1.0, +0.25, +0.0, +0.2, +0.2, 0 },
...
static const struct Waypoint route2[ROUTE_2_N_WAYPOINTS] = {
  ...
  { { +6.6, +3.5, -1.5 }, +1.0, +0.25, +0.0, +0.2, +0.2, 0 },
  { { +6.6, -0.5, -1.5 }, +1.0, +0.25, +0.0, +0.2, +0.2, 0 },
  { { +11.2, -0.5, -1.5 }, +1.0, +0.25, +0.0, +0.2, +0.2, 0 },
  { { +11.2, +3.5, -1.5 }, +1.0, +0.25, +0.0, +0.2, +0.2, 5000 },
  { { +11.2, -0.5, -1.5 }, +1.0, +0.25, +0.0, +0.2, +0.2, 0 },
  { { +6.6, -0.5, -1.5 }, +1.0, +0.25, +0.0, +0.2, +0.2, 0 },
  { { +6.6, +3.5, -1.5 }, +1.0, +0.25, +0.0, +0.2, +0.2, 0 },
  { { +2.0, +3.5, -1.5 }, +1.0, +0.25, +0.0, +0.2, +0.2, 0 },
