...
static const struct Waypoint route0[ROUTE_0_N_WAYPOINTS] = {
  { { +0.0, +0.0, -1.5 }, +0.75, +0.35, +0.0, +0.2, +0.2, 5000 },
  { { +2.0, +0.0, -1.5 }, +0.75, +0.50, +0.0, +0.2, +0.2, 0 },
  { { +2.0, +4.0, -1.5 }, +0.75, +0.50, +0.0, +0.2, +0.2, 0 },
  { { +4.5, +4.0, -1.5 }, +0.75, +0.35, +0.0, +0.2, +0.2, 10000 },
  { { +2.0, +4.0, -1.5 }, +0.75, +0.35, +0.0, +0.2, +0.2, 0 },
  { { +2.0, +0.0, -1.5 }, +0.75, +0.50, +0.0, +0.2, +0.2, 0 },
...
static const struct Waypoint route1[ROUTE_1_N_WAYPOINTS] = {
  ...
  { { +6.1, +0.0, -2.25 }, +0.75, +0.35, +0.0, +0.2, +0.2, 8000 },
  { { +2.0, +0.0, -2.25 }, +0.75, +0.35, +0.0, +0.2, +0.2, 0 },
  { { +0.0, +0.0, -1.5 }, +0.75, +0.35, +0.0, +0.2, +0.2, 2000 },
  { { +0.0, +0.0, +1.5 }, +0.50, +0.35, +0.0, +0.2, +0.2, 0 },
};
...
static const struct Waypoint route2[ROUTE_2_N_WAYPOINTS] = {
  { { +0.0, +0.0, -1.5 }, +0.75, +0.35, +0.0, +0.2, +0.2, 5000 },
  { { +0.5, +0.0, -1.5 }, +0.75, +0.50, +0.0, +0.2, +0.2, 0 },
  { { +0.5, +4.0, -1.5 }, +0.75, +0.50, +0.0, +0.2, +0.2, 0 },
  { { +4.5, +4.0, -1.5 }, +0.75, +0.50, +0.0, +0.2, +0.2, 0 },
  { { +5.1, -0.1, -1.5 }, +0.75, +0.50, +0.0, +0.2, +0.2, 0 },
  { { +9.2, -0.1, -1.75 }, +0.75, +0.50, +0.0, +0.2, +0.2, 2500 },
  { { +9.2, +1.6, -1.75 }, +0.75, +0.50, +0.0, +0.2, +0.2, 8000 },
  { { +9.2, -0.1, -1.75 }, +0.75, +0.50, +0.0, +0.2, +0.2, 0 },
  { { +5.1, -0.1, -2.25 }, +0.75, +0.35, +0.0, +0.2, +0.2, 0 },
  { { +0.5, +0.0, -2.25 }, +0.75, +0.35, +0.0, +0.2, +0.2, 0 },
