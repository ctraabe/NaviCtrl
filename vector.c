  ...
  float * result)
{
  ...
  for (size_t i = 0; i < length; i++) *result_ptr++ = *v1++ + *v2++;
...
// -----------------------------------------------------------------------------
float * VectorAddToSelf(float *v1, const float *v2, size_t length)
{
  float * ptr = v1;
  for (size_t i = 0; i < length; i++) *ptr++ += *v2++;

  return v1;
}

// -----------------------------------------------------------------------------
float * VectorScale(const float * v, float scalar, size_t length,
  float * result)
{
  float * result_ptr = result;
  for (size_t i = length; i; i--) *result_ptr++ = *v++ * scalar;

  return result;
}

// -----------------------------------------------------------------------------
float * VectorScaleSelf(float * v, float scalar, size_t length)
{
  float * ptr = v;
  for (size_t i = length; i; i--) *ptr++ *= scalar;

  return v;
}

// -----------------------------------------------------------------------------
float * VectorSubtract(const float *v1, const float *v2, size_t length,
  float * result)
{
  float * result_ptr = result;
  for (size_t i = 0; i < length; i++) *result_ptr++ = *v1++ - *v2++;
...
// -----------------------------------------------------------------------------
float * VectorSubtractFromSelf(float *v1, const float *v2, size_t length)
{
  float * ptr = v1;
  for (size_t i = 0; i < length; i++) *ptr++ -= *v2++;
